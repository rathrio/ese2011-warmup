...
import warmup.CalendarApplication;
import warmup.Event;
import warmup.User;
...
public class EventTest {
	...
	public void init() {
		...
		this.owner = calApp.getUsers().get(0);
	}
	...
	public void shouldBeNamedCorrectly() {
		...
		Event lunch = new Event("Lunch with Mom", firstStartDate, firstEndDate);
	...
	public void shouldChangeVisibility() {
		firstStartDate = owner.parseStringToDate("23.09.11 18:00");
		firstEndDate = owner.parseStringToDate("23.09.11 20:00");
		Event event = new Event("testEvent", firstStartDate, firstEndDate);
	...
	public void shouldBeComparable() {
		...
		Event thirdEvent = new Event("thirdEvent", thirdStartDate, thirdEndDate);
	...
	public void shouldHappenOnSpecificDate() {
		...
		Event testEvent = new Event("Fuetzfues Birthday", firstStartDate, firstEndDate);
	...
	public void shouldHappenOnSpecificDateIfEventSpansOverSpecifiedDay() {
		...
		this.testDate = owner.parseStringToDate("24.09.11 23:00");
		testEvent = new Event("Fuetzfues Birthday", firstStartDate, firstEndDate);
		assertTrue(testEvent.happensOn(testDate));
	}
